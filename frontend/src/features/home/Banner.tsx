  ...
  return (
    <section className="w-full bg-orange-300 h-60 flex justify-between items-center max-w-6xl mx-auto">
      ...
      <div className="ml-20 text-2xl font-bold">
        ...
        <button
          className="bg-orange-100 hover:bg-orange-50 transition-all duration-400 hover:shadow flex justify-center items-center gap-1 mt-4 text-[0.75rem] font-medium px-2 py-1 justify-self-end rounded-2xl cursor-pointer"
          onClick={handleClick}
        >
